...
function App() {
  ...
  let data = "your data is in text";

  let users = ["ram", "shyam", "rohan", "shoan",'sonam','ramesh'];

  if (name == "rm") {
    imgurl =
      "https://images.samsung.com/is/image/samsung/p6pim/in/sm-m146bzbgins/gallery/in-galaxy-m14-5g-4gb-ram-sm-m146bzbgins-537266362?$2052_1641_PNG$";
  } else {
...
<User name = 'rakes' age = {65} /> */}
      ...
      <Profile
        userdata={users}
        data={data}
        otherinfo="Helelo Ohter infor being send"
      />
